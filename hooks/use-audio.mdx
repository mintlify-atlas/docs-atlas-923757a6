...
<Note>
For global audio management across the application, consider using the `AudioProvider` context instead. See the [Background Audio](/features/background-audio) feature documentation for more details.
</Note>
...
- [Background Audio](/features/background-audio) - Global audio management with user consent
- [State Management](/architecture/state-management) - AudioProvider context for app-wide audio control