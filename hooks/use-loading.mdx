...
- [Background Audio](/features/background-audio) - Works together with loading for user consent
- [Atoms](/components/atoms) - LoadingScreen component that uses this hook